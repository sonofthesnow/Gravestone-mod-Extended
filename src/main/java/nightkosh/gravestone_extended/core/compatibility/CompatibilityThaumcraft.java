...
//                    .add(Aspect.UNDEAD, 20).add(Aspect.SOUL, 20).add(Aspect.ELDRITCH, 20));
//            // bone blocks
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_BLOCK), new int[]{0}, new AspectList().add(Aspect.DEATH, 9).add(Aspect.FLESH, 9));
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_BLOCK), new int[]{1}, new AspectList().add(Aspect.DEATH, 9).add(Aspect.FLESH, 9)
//                    .add(Aspect.UNDEAD, 9).add(Aspect.SOUL, 9));
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_BLOCK), new int[]{2}, new AspectList().add(Aspect.DEATH, 9).add(Aspect.FLESH, 9)
//                    .add(Aspect.TRAP, 2).add(Aspect.UNDEAD, 5));
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_BLOCK), new int[]{3}, new AspectList().add(Aspect.DEATH, 9).add(Aspect.FLESH, 9)
//                    .add(Aspect.UNDEAD, 9).add(Aspect.SOUL, 9).add(Aspect.TRAP, 2));
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_SLAB), new AspectList().add(Aspect.DEATH, 4).add(Aspect.FLESH, 4));
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.BONE_STAIRS), new AspectList().add(Aspect.DEATH, 6).add(Aspect.FLESH, 6));
//            // haunted chest
//            ThaumcraftApi.registerObjectTag(new ItemStack(GSBlock.HAUNTED_CHEST), new AspectList().add(Aspect.SOUL, 5).add(Aspect.MAGIC, 5)
