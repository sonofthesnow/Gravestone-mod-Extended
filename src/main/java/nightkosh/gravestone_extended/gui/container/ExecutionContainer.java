 ...
 */
public class ExecutionContainer extends Container {

    protected TileEntityExecution tileEntity;
    public static final int PLAYER_INVENTORY_ROWS_COUNT = 3;
    public static final int COLUMNS_COUNT = 9;
    public static final int SLOT_WIDTH = 18;

    public ExecutionContainer(InventoryPlayer inventoryPlayer, TileEntityExecution te) {
        tileEntity = te;

        this.addSlotToContainer(new ExecutionSlot(tileEntity, 0, 27, 27));
