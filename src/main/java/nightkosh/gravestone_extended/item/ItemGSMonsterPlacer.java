...
public class ItemGSMonsterPlacer extends ItemMonsterPlacer {
    ...
    public static enum EnumEggs {
        ...
        STRAY_SKULL_CRAWLER(Entity.STRAY_SKULL_CRAWLER_NAME, Entity.STRAY_SKULL_CRAWLER_ID, STRAY_BACKGROUND_COLOR, CRAWLER_FOREGROUND_COLOR),
        ...
        HUSK_SKULL_CRAWLER(Entity.HUSK_SKULL_CRAWLER_NAME, Entity.HUSK_SKULL_CRAWLER_ID, HUSK_BACKGROUND_COLOR, CRAWLER_FOREGROUND_COLOR),
        PIGMAN_SKULL_CRAWLER(Entity.PIGMAN_SKULL_CRAWLER_NAME, Entity.PIGMAN_SKULL_CRAWLER_ID, PIGMAN_BACKGROUND_COLOR, CRAWLER_FOREGROUND_COLOR),
        ...
        TOXIC_SLUDGE(Entity.TOXIC_SLUDGE_NAME, Entity.TOXIC_SLUDGE_ID, TOXIC_SLUDGE_BACKGROUND_COLOR, TOXIC_SLUDGE_FOREGROUND_COLOR);//,
